 ...
 */
public enum StandardEntityType implements EntityType {
    ...
    private StandardEntityType(int id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    /**
       ...
       @return A StandardEntityType instance with the right ID.
       @throws IllegalArgumentException If the ID is not recognised.
     */
    public static StandardEntityType fromID(int id) {
        for (StandardEntityType next : values()) {
            if (next.id == id) {
                return next;
            }
        }
