...
There are two tools that can assist in creating a scenario: Scenario Editor and Random Scenario. Please refer the https://roborescue.github.io/rcrs-server/docs/rcrs-server/index.html[RoboCup Rescue Simulator Manual] for information of how to run these tools.
