...
public class ConfigTest {
    ...
    private final static String BASIC_CONFIG = "rescuecore/config/basic.cfg";
    private final static String INCLUDE_CONFIG = "rescuecore/config/include.cfg";
    private final static String INCLUDE_CONFIG_2 = "rescuecore/config/include2.cfg";
    private final static String MORE_CONFIG = "rescuecore/config/more.cfg";
    private final static String WHITESPACE_CONFIG = "rescuecore/config/whitespace.cfg";
    private final static String CONFIG_DIR = "rescuecore/config/configdir";
    private final static String CONFIG_TREE = "rescuecore/config/configtree";
    private final static String CONFIG_INCLUDE_SUBDIR_FILE = "rescuecore/config/include_subdir_file.cfg";
    private final static String CONFIG_INCLUDE_SUBDIR = "rescuecore/config/include_subdir.cfg";
    private final static String NONEXISTANT_INCLUDE = "rescuecore/config/nonexistant_include.cfg";
    private final static String EMPTY_INCLUDE = "rescuecore/config/empty_include.cfg";
    private final static String MALFORMED_1 = "rescuecore/config/malformed1.cfg";
    private final static String MALFORMED_2 = "rescuecore/config/malformed2.cfg";
    private final static String MALFORMED_3 = "rescuecore/config/malformed3.cfg";
    private final static String MALFORMED_4 = "rescuecore/config/malformed4.cfg";
    private final static String MALFORMED_5 = "rescuecore/config/malformed5.cfg";
    private final static String MALFORMED_6 = "rescuecore/config/malformed6.cfg";
    private final static String BOOLEAN_CONFIG = "rescuecore/config/boolean.cfg";
