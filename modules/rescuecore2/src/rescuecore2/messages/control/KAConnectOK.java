...
public class KAConnectOK extends AbstractMessage {
   ...
   *          The request ID.
   * @param agentID
   *          The ID of the Entity that the agent will be controlling.
   * @param allEntities
   *          All Entities that the agent knows about, including the controlled
   *          object.
   * @param config
  ...
  public void write( OutputStream out ) throws IOException {
    KAConnectOKProto.Builder kaConnectOKBuilder = KAConnectOKProto.newBuilder()
