...
public class AKConnect extends AbstractMessage {
   ...
   *          The set of requested entity types.
   */
  ...
  public void write( OutputStream out ) throws IOException {
    AKConnectProto akConnect = AKConnectProto.newBuilder()
        .setRequestID( this.requestID ).setVersion( this.version )
        .setAgentName( this.agentName )
        .addAllRequestedEntityTypes( this.requestedEntityTypes ).build();
  ...
  public void read( InputStream in ) throws IOException {
    ...
    this.requestedEntityTypes = akConnect.getRequestedEntityTypesList()
        .subList( 0, akConnect.getRequestedEntityTypesCount() );
  }
}