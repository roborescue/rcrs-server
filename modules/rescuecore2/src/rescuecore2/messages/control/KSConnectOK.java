...
public class KSConnectOK extends AbstractMessage {
   ...
   *
   * @param simID
   *          The ID of the simulator that has successfully connected.
   * @param requestID
   *          The request ID.
   * @param allEntities
   *          All Entities in the world.
   * @param config
   *          The Config that the simulator knows about.
   */
  ...
  public void write( OutputStream out ) throws IOException {
    KSConnectOKProto.Builder ksConnectOKBuilder = KSConnectOKProto.newBuilder()
