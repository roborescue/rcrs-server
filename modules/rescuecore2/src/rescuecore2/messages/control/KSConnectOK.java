...
public class KSConnectOK extends AbstractMessage implements Control {
	 ...
	 * 
	 * @param simulatorID The ID of the simulator that has successfully
	 *                    connected.
	 * @param requestID   The request ID.
	 * @param allEntities All Entities in the world.
	 * @param config      The Config that the simulator knows about.
	 */
	public KSConnectOK(int simulatorID, int requestID,
			Collection<? extends Entity> allEntities, Config config) {
		this();
