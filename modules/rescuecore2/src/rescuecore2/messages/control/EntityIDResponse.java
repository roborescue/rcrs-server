...
public class EntityIDResponse extends AbstractMessage {
  ...
  /**
   * Construct an EntityIDResponse message that populates its data from a
   * stream.
   *
   * @param in
   ...
   *
   * @param simID
   *          The ID of the simulator making the request.
   * @param requestID
   *          A unique ID number for this request.
   * @param ids
   *          The new EntityIDs.
   */
  ...
  public void write( OutputStream out ) throws IOException {
    EntityIDResponseProto.Builder entityIDResponseBuilder = EntityIDResponseProto
        .newBuilder().setSimID( this.simID ).setRequestID( this.requestID );
  ...
  public void read( InputStream in ) throws IOException {
    EntityIDResponseProto entityIDResponse = EntityIDResponseProto
        .parseFrom( in );
