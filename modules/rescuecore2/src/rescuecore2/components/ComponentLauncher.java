...
public abstract class ComponentLauncher implements RequestIDGenerator {
  ...
  /**
   * Connect a Component to the kernel. Throws a ComponentConnectionException if
   * the connection fails due to a kernel ConnectError message.
   *
   * @param c
   ...
   */
  public void connect( Component c ) throws InterruptedException,
      ConnectionException, ComponentConnectionException {
