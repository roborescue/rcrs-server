...
public interface Agent extends Component {
   ...
   * @param entities
   *          The set of Entities the kernel sent to this agent on connection.
   * @param config
  ...
  /**
   * Get the ID of the entity this agent controls. If the agent has not yet been
   * connected to the kernel then null will be returned.
   *
