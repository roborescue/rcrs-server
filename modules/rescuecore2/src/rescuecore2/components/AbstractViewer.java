 ...
 *
 * @param <T>
 *          The subclass of WorldModel that this viewer understands.
 */
public abstract class AbstractViewer<T extends WorldModel<? extends Entity>>
    extends AbstractComponent<T> implements Viewer {
  ...
  public void connect( Connection connection, RequestIDGenerator generator,
    ...
    ViewerConnectionListener l = new ViewerConnectionListener( requestID,
        latch );
   ...
   *
   * @param timestep
   *          The KVTimestep object.
   */
  protected void handleTimestep( KVTimestep timestep ) {
    ChangeSet changes = timestep.getChanges();
