...
public final class Constants {
  ...
  public static final String  COMMAND_FACTORY_KEY         = "factory.commands";
  ...
  public static final String  ENTITY_URN_PREFIX           = "entity:";
  /** Prefix for property URNs. */
  public static final String  PROPERTY_URN_PREFIX         = "property:";
  /** Prefix for command URNs. */
  public static final String  COMMAND_URN_PREFIX          = "command:";
  /** Prefix for message URNs. */
  public static final String  MESSAGE_URN_PREFIX          = "message:";
