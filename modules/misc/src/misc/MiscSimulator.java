...
public class MiscSimulator extends StandardSimulator implements GUIComponent {
  ...
  static private int                     GAS_STATION_EXPLOSION_RANGE;
  static private int                     GAS_STATION_BURIEDNESS_BOUND;
  static private int                     GAS_STATION_BURIEDNESS_MIN;
  static private int                     GAS_STATION_DAMAGE_BOUND;
  static private int                     GAS_STATION_DAMAGE_MIN;
  ...
  protected void postConnect() {
    ...
    this.parameters = new MiscParameters( config );
    GAS_STATION_EXPLOSION_RANGE = config
    ...
    this.oldBrokenBuildingsBuriedness = new HashMap<EntityID, Integer>();
    ...
    this.notExplosedGasStations = new HashSet<>();
    for ( Entity e : model.getAllEntities() ) {
      if ( e instanceof GasStation ) {
        this.notExplosedGasStations.add( e.getID() );
      }
      if ( e instanceof Building ) {
        e.addEntityListener( buildingListener );
        ...
        for ( HumanAttributes hA : humans.values() ) {
          ...
          if ( GeometryTools2D.getDistance(
              ...
              new Point2D( gasStation.getX(),
                  gasStation.getY() ) ) < GAS_STATION_EXPLOSION_RANGE ) {
