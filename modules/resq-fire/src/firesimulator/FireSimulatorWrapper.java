...
public class FireSimulatorWrapper extends StandardSimulator
    ...
    for ( EntityID id : u.getChanges().getChangedEntities() ) {
      ...
      if ( r == null ) {
        ...
        if ( r instanceof Building
            && e instanceof rescuecore2.standard.entities.Building ) {
          Building b = (Building) r;
          mapBuildingProperties( (rescuecore2.standard.entities.Building) e,
              b );
        ...
        } else if ( r instanceof MovingObject
            && e instanceof rescuecore2.standard.entities.Human ) {
          mapHumanProperties( (rescuecore2.standard.entities.Human) e,
              (MovingObject) r );
  ...
  protected void processCommands( KSCommands c, ChangeSet changes ) {
    ...
    for ( Command next : c.getCommands() ) {
      if ( next instanceof AKExtinguish ) {
        ...
        FireBrigade source = (FireBrigade) world
            .getObject( agentID.getValue() );
    ...
    for ( Object next : world.getBuildings() ) {
      ...
      if ( ( !oldB.isFierynessDefined() )
          || ( oldB.getFieryness() != b.getFieryness() ) ) {
        oldB.setFieryness( b.getFieryness() );
        changes.addChange( oldB, oldB.getFierynessProperty() );
      }
      if ( ( !oldB.isTemperatureDefined() )
          || ( oldB.getTemperature() != (int) b.getTemperature() ) ) {
    ...
    for ( Object next : world.getFirebrigades() ) {
      ...
      if ( ( !oldFB.isWaterDefined() )
          || ( oldFB.getWater() != fb.getWaterQuantity() ) ) {
  ...
  private void mapBuildingProperties(
      rescuecore2.standard.entities.Building oldB, Building newB ) {
  ...
  private void mapHumanProperties( rescuecore2.standard.entities.Human oldH,
      MovingObject newH ) {
    ...
    if ( oldH instanceof rescuecore2.standard.entities.FireBrigade
        && newH instanceof FireBrigade ) {
