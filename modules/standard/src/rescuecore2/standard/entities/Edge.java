...
public class Edge {
   ...
   * @param endX      The X coordinate of the second endpoint.
   * @param endY      The Y coordinate of the second endpoint.
   * @param neighbour The ID of the neighbour on the other side of this edge. This
   *                  may be null to indicate an impassable edge.
   */
  ...
  public String toString() {
    return "Edge from " + this.start + " to " + this.end + " ("
        + (this.neighbour == null ? "impassable" : "neighbour: " + this.neighbour) + ")";
  }
}
