...
public abstract class Human extends StandardEntity {
  ...
  public JSONObject toJson() {
    ...
    jsonObject.put( "Damage", this.isDamageDefined() ? this.getDamage() : JSONObject.NULL );
    jsonObject.put( "HP", this.isHPDefined() ? this.getHP() : JSONObject.NULL );
    jsonObject.put( "Pos", this.isPositionDefined() ? new int[]{getX(), getY()} : JSONObject.NULL);
