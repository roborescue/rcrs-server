...
public interface Channel {
  ...
  /**
   * Set the input noise object for this channel. Input noise is applied to the
   * message once on arrival.
   *
   * @param noise
   *          The input noise.
   */
  ...
  /**
   * Set the output noise object for this channel. Output noise is applied to
   * the message once for each listener as it is sent.
   *
   * @param noise
   *          The output noise.
   */
