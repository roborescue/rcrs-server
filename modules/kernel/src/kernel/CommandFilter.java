...
public interface CommandFilter {
  ...
  /**
   * Filter a set of agent commands. Any illegal commands should be removed from
   * the given collection.
   *
   * @param commands The commands to filter. This collection should be modified to
   *                 remove any illegal commands.
