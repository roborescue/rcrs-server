...
/**
 * Implementations of this interface are responsible for determining what
 * entities/properties each agent can see.
 */
public interface Perception {
  ...
  /**
   * Determine what Entities are visible to a particular agent. The returned
   * Entities should be copies of Entities in the ground-truth WorldModel. Only
   * visible properties should have defined values.
   *
